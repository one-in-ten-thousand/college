class Universities::FormFields < BaseComponent
  ...
  def render
    div do
      ...
      mount Shared::Field, operation.score_2023_mix, "2023学校录取最低分", &.number_input(placeholder: "录取最低分")
      mount Shared::Field, operation.ranking_2023_mix, "2023学校录取最低位次", &.number_input(placeholder: "录取最低位次")
